	...
	<div class="container">
		<div class="row ">
			...
			<div class="col-md-3 mt-3">
				...
				<a href="index.php" class="btn btn-danger btn-block " >Order Now</a>
				  ...
				  <ul class="list-group list-group-flush">
				    	...
				    	$user_id=$_SESSION['user_id'];
							...
							while($row4=mysqli_fetch_array($result4))
							{
							 ...
							 echo '<li class="list-group-item">Orders<span class="float-right"> '.$counter1.'</span></li>
					<li class="list-group-item">Reviews<span class="float-right">'.$counter1.' </span></li>
				    <li class="list-group-item text-danger"><b><a href="logout.php">Log out</a></b></li>';
							...
							<div class="card-body">
								...
								<?php
									...
									$query5="SELECT * FROM users WHERE user_id='$user_id'";
										...
										echo '<h5 class="mt-1">Address: </h5> <button data-toggle="modal" data-target="#addressModal" class="btn btn-danger btn-block mt-2 rate_address" data-id="'.$result5['user_id'].'">Add/Update</button>
								<div>
